...
DELIMITER $$
CREATE FUNCTION patient_date_enrolled(my_patient_id bigint) RETURNS DATE
DETERMINISTIC
BEGIN
...
DELIMITER $$
CREATE FUNCTION date_antiretrovirals_started(set_patient_id bigint, min_state_date DATE) RETURNS DATE
BEGIN
...
DELIMITER $$
CREATE FUNCTION earliest_start_date_at_clinic(set_patient_id bigint) RETURNS DATE
BEGIN
...
DELIMITER $$
CREATE FUNCTION `patient_outcome`(patient_id bigint, visit_date date) RETURNS varchar(25)
BEGIN
DECLARE set_program_id bigint;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_defaulter`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS int(1)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `drug_pill_count`(my_patient_id BIGINT, my_drug_id INT, my_date DATE) RETURNS DECIMAL
BEGIN
  DECLARE done INT DEFAULT FALSE;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_state_for_program`(my_patient_id BIGINT, my_program_id INT, my_end_date DATETIME) RETURNS int(11)
BEGIN
  SET @state_id = NULL;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_state_for_patient_in_flat_tables`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS varchar(255)
BEGIN
  SET @state_id = NULL;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_hiv_program_start_date_max`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
  SET @patient_id = NULL;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `last_text_for_obs`(my_patient_id BIGINT, my_encounter_type_id INT, my_concept_id INT, my_regimem_given INT, unknown_regimen_value INT, my_end_date DATETIME) RETURNS varchar(255)
BEGIN
  SET @obs_value = NULL;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_text_for_obs`(my_patient_id BIGINT, my_encounter_type_id INT, my_concept_id INT, my_end_date DATETIME) RETURNS VARCHAR(255)
BEGIN
  SET @obs_value = NULL;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_value_for_obs`(my_patient_id BIGINT, my_encounter_type_id INT, my_concept_id INT, my_end_date DATETIME) RETURNS int(11)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_value_for_obs_at_initiation`(my_patient_id BIGINT, my_earliest_start_date DATETIME, my_encounter_type_id INT, my_concept_id INT, my_end_date DATETIME) RETURNS int(11)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `current_defaulter_date`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS DATE
BEGIN
  DECLARE done INT DEFAULT FALSE;
...
CREATE FUNCTION patient_reason_for_starting_art(my_patient_id BIGINT) RETURNS INT
BEGIN
...
CREATE FUNCTION patient_reason_for_starting_art_text(my_patient_id BIGINT) RETURNS VARCHAR(255)
BEGIN
...
CREATE FUNCTION patient_current_regimen(my_patient_id BIGINT, my_date DATE) RETURNS VARCHAR(10)
BEGIN
  DECLARE max_obs_datetime DATETIME;
  ...
  SET @regimen_zero_p_four    := ('968,1044');
  SET @regimen_zero_p_five    := ('22,1044');
  ...
  SET @regimen_nine_p_six     := ('74,1044');
  SET @regimen_nine_p_seven   := ('73,1044');
  SET @regimen_nine_p_eight   := ('979,1044');
  ...
  SET @regimen_seventeen_p      := ('30,1044');
  SET @regimen_seventeen_p_two  := ('30,733');
  SET @regimen_seventeen_p_three  := ('733,954');
  SET @regimen_seventeen_p_four  := ('29,733');
  SET @regimen_seventeen_p_five  := ('28,733');
  SET @regimen_seventeen_p_six  := ('11,733');
  SET @regimen_seventeen_p_seven  := ('29,1044');
  SET @regimen_seventeen_p_eight  := ('28,1044');
  SET @regimen_seventeen_p_nine  := ('11,1044');
  ...
  IF @drug_ids IN(@regimen_zero_p_four) AND (length(@drug_ids) = length(@regimen_zero_p_four)) THEN
    SET regimen_cat = ('0P');
  END IF;

  IF @drug_ids IN(@regimen_zero_p_five) AND (length(@drug_ids) = length(@regimen_zero_p_five)) THEN
    SET regimen_cat = ('0P');
  END IF;
  ...
  IF @drug_ids IN(@regimen_nine_p_six) AND (length(@drug_ids) = length(@regimen_nine_p_six)) THEN
    SET regimen_cat = ('9P');
  END IF;

  IF @drug_ids IN(@regimen_nine_p_seven) AND (length(@drug_ids) = length(@regimen_nine_p_seven)) THEN
    SET regimen_cat = ('9P');
  END IF;

  IF @drug_ids IN(@regimen_nine_p_eight) AND (length(@drug_ids) = length(@regimen_nine_p_eight)) THEN
    SET regimen_cat = ('9P');
  END IF;
  /* Regimen NINE ENDS............................................................................. */
  ...
  /* Regimen FOURTEEN............................................................................. */
  IF @drug_ids IN(@regimen_fourteen_a) AND (length(@drug_ids) = length(@regimen_fourteen_a)) THEN
    SET regimen_cat = ('14A');
  END IF;
  ...
  IF @drug_ids IN(@regimen_fifteen_a) AND (length(@drug_ids) = length(@regimen_fifteen_a)) THEN
    SET regimen_cat = ('15A');
  END IF;
  /* Regimen FIFTEEN ENDS............................................................................. */

  /* Regimen SIXTEEN............................................................................. */
  IF @drug_ids IN(@regimen_sixteen_a) AND (length(@drug_ids) = length(@regimen_sixteen_a)) THEN
    SET regimen_cat = ('16A');
  END IF;

  IF @drug_ids IN(@regimen_sixteen_p) AND (length(@drug_ids) = length(@regimen_sixteen_p)) THEN
    SET regimen_cat = ('16P');
  END IF;

  IF @drug_ids IN(@regimen_sixteen_p_two) AND (length(@drug_ids) = length(@regimen_sixteen_p_two)) THEN
    SET regimen_cat = ('16P');
  END IF;

  IF @drug_ids IN(@regimen_sixteen_p_three) AND (length(@drug_ids) = length(@regimen_sixteen_p_three)) THEN
    SET regimen_cat = ('16P');
  END IF;
  ...
  IF @drug_ids IN(@regimen_seventeen_p) AND (length(@drug_ids) = length(@regimen_seventeen_p)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_two) AND (length(@drug_ids) = length(@regimen_seventeen_p_two)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_three) AND (length(@drug_ids) = length(@regimen_seventeen_p_three)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_four) AND (length(@drug_ids) = length(@regimen_seventeen_p_four)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_five) AND (length(@drug_ids) = length(@regimen_seventeen_p_five)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_six) AND (length(@drug_ids) = length(@regimen_seventeen_p_six)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_seven) AND (length(@drug_ids) = length(@regimen_seventeen_p_seven)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_eight) AND (length(@drug_ids) = length(@regimen_seventeen_p_eight)) THEN
    SET regimen_cat = ('17P');
  END IF;

  IF @drug_ids IN(@regimen_seventeen_p_nine) AND (length(@drug_ids) = length(@regimen_seventeen_p_nine)) THEN
    SET regimen_cat = ('17P');
  END IF;
  /* Regimen SEVENTEEN ENDS............................................................................. */
...
CREATE FUNCTION last_text_for_obs(my_patient_id BIGINT, my_encounter_type_id INT, my_concept_id INT, my_regimem_given INT, unknown_regimen_value INT, my_end_date DATETIME) RETURNS varchar(255)
...
CREATE FUNCTION `drug_pill_count`(my_patient_id BIGINT, my_drug_id INT, my_date DATE) RETURNS decimal(10,0)
BEGIN
  DECLARE done INT DEFAULT FALSE;
  DECLARE my_pill_count, my_total_text, my_total_numeric DECIMAL;
...
CREATE FUNCTION `current_defaulter`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS int(1)
BEGIN
  DECLARE done INT DEFAULT FALSE;
  DECLARE my_start_date, my_expiry_date, my_obs_datetime DATETIME;
  DECLARE my_daily_dose, my_quantity, my_pill_count, my_total_text, my_total_numeric DECIMAL;
...
DROP FUNCTION IF EXISTS `current_defaulter_date`;
CREATE FUNCTION current_defaulter_date(my_patient_id BIGINT, my_end_date date) RETURNS varchar(25)
DETERMINISTIC
BEGIN
DECLARE done INT DEFAULT FALSE;
  DECLARE my_start_date, my_expiry_date, my_obs_datetime, my_defaulted_date DATETIME;
...
CREATE FUNCTION re_initiated_check(set_patient_id BIGINT, set_date_enrolled DATE) RETURNS VARCHAR(15)
DETERMINISTIC
BEGIN
...
CREATE FUNCTION died_in(set_patient_id BIGINT, set_status VARCHAR(25), date_enrolled DATE) RETURNS varchar(25)
DETERMINISTIC
BEGIN
...
CREATE  FUNCTION `current_pepfar_defaulter`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS int(1)
BEGIN
  DECLARE done INT DEFAULT FALSE;
  DECLARE my_start_date, my_expiry_date, my_obs_datetime DATETIME;
  DECLARE my_daily_dose, my_quantity, my_pill_count, my_total_text, my_total_numeric DECIMAL;
  ...
  read_loop: LOOP
    ...
    IF DATEDIFF(my_end_date, my_expiry_date) > 30 THEN
        SET flag = 1;
    END IF;
...
CREATE FUNCTION `current_pepfar_defaulter_date`(my_patient_id BIGINT, my_end_date DATETIME) RETURNS DATE
BEGIN
  DECLARE done INT DEFAULT FALSE;
  DECLARE my_start_date, my_expiry_date, my_obs_datetime, my_defaulted_date DATETIME;
  DECLARE my_daily_dose, my_quantity, my_pill_count, my_total_text, my_total_numeric DECIMAL;
...
CREATE FUNCTION `patient_screened_for_tb`(my_patient_id BIGINT, my_start_date DATE, my_end_date DATE) RETURNS INT
BEGIN
...
CREATE FUNCTION `patient_given_ipt`(my_patient_id BIGINT, my_start_date DATE, my_end_date DATE) RETURNS INT
BEGIN
...
CREATE FUNCTION female_maternal_status(my_patient_id BIGINT, end_datetime datetime) RETURNS VARCHAR(20)
DETERMINISTIC
BEGIN
...
CREATE FUNCTION `patient_tb_status`(my_patient_id BIGINT, my_end_date DATE) RETURNS INT
BEGIN
  DECLARE screened INT DEFAULT FALSE;
...
CREATE FUNCTION `patient_latest_adherence`(my_patient_id BIGINT, my_end_date DATE) RETURNS VARCHAR(100)
BEGIN
...
CREATE FUNCTION `patient_has_side_effects`(my_patient_id BIGINT, my_end_date DATE) RETURNS VARCHAR(7)
BEGIN
...
CREATE FUNCTION `patient_who_stage`(my_patient_id BIGINT) RETURNS VARCHAR(50)
BEGIN
