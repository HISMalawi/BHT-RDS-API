...
CREATE TABLE `care_setting` (
  ...
  `retired_by` bigint(20) DEFAULT NULL,
...
CREATE TABLE `obs` (
  ...
  `location_id` int(11) DEFAULT NULL,
  `obs_group_id` bigint(20) DEFAULT NULL,
  `accession_number` varchar(255) DEFAULT NULL,
  `value_group_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `order_group` (
  `order_group_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `orders` (
  ...
  `order_group_id` bigint(20) DEFAULT NULL,
  `sort_weight` double DEFAULT NULL,
...
CREATE TABLE `patient_identifier` (
  `patient_identifier_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `patient_id` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE `patient_program` (
  `patient_program_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `patient_id` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE `patient_program_attribute` (
  ...
  `patient_program_id` bigint(20) NOT NULL,
  `attribute_type_id` int(11) NOT NULL,
  `value_reference` text NOT NULL,
  `uuid` char(38) NOT NULL,
  `creator` bigint(20) NOT NULL,
...
CREATE TABLE `patient_state` (
  `patient_state_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `patient_program_id` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE `person_merge_log` (
  ...
  `winner_person_id` bigint(20) NOT NULL,
  `loser_person_id` bigint(20) NOT NULL,
  `creator` bigint(20) NOT NULL,
  `date_created` datetime NOT NULL,
...
--
-- Dumping events for database 'openmrs'
--
...
-- Dump completed on 2019-04-08  9:38:35
